...
public class GymChainInfo {
    ...
    public static final String WOLF_GYM_NAME = "Wolf Gym";
    public static final String CHRIS_MEMBER_NAME = "Chris";
    ...
    private static void initializeGym0(Gym gym){
        ...
        // Create weight objects
         ...
         Treadmill tread = new Treadmill();

         // Add cardio machines to gym
         gym.addCardioMachine(bike);
         gym.addCardioMachine(tread);

         // Create classes
         FitnessClass fc1 = new FitnessClass("Krav Maga", "All The Time");
         FitnessClass fc2 = new FitnessClass("Parkour", "12 PM");
