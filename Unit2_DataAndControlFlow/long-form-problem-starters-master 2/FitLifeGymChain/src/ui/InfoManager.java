...
public class InfoManager {
    ...
    private static final String YOUR_GYM_COMMAND = "wolf";
    ...
    private void printInstructions(){
        ...
        System.out.println("Enter '" + YOUR_GYM_COMMAND + "' for Fitlife " + WOLF_GYM_NAME);
        ...
        if (str.length() > 0) {
            switch (str) {
                ...
                case YOUR_GYM_COMMAND:
                    printGymInfo(chain.lookupGymByName(WOLF_GYM_NAME));
                    break;
